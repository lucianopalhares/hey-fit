export const state = () => ({
  ...
  export const mutations = {
    ...
    STORE (state, item) {
      ...
      this.$axios.$post('/api/usuario',item).then(response => {
    ...
    UPDATE (state, item) { 
      ...
      if(Object.keys(state.items).length > 0
        ...
        this.$axios.$put('/api/usuario/'+state.item.id,item).then(response => {
    ...
    DELETE_ITEM (state) {
      ...
      if(Object.keys(state.items).length > 0
        ...
        this.$axios.$delete('/api/usuario/'+state.item.id).then(response => {
    ...
    FETCH_ITEMS (state, payload) {
      ...
      this.$axios.$post('/api/filtra-usuarios',{where:payload}).then(response => {
